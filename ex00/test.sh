...
run_test "127" "nondisplayable ->last char <DEL>"
run_test "32" "displayable char <SPACE>"
...
run_test "3.402823e+38f" "Float MAX with f suffix"
run_test "3.5e38" "float overflow but within doulbe"

printf "${GREEN}==========DOUBLE TEST=============${RESET}\n"
run_test "1e400" "double overflow"
run_test "3.1234567890123456789" "loss precision"
run_test "1.797693e+308" "double max"
